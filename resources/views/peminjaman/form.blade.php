            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="au-breadcrumb-content">
                        ...
                        <a href="peminjaman" type="button" class="au-btn au-btn-icon au-btn--green">
                            Kembali
                        </a>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="table-responsive m-b-40">
                        <form action="{{ url('pinjam') }}" method="POST">
                            ...
                            <div class="form-group">
                                <label for="jumlah" class=" form-control-label">Jumlah Dipinjam</label>
                                <input type="number" id="jumlahpinjam" name="jumlah_dipinjam" placeholder="Jumlah Pinjam.." class="form-control">
                            </div>
                            <div class="form-group">
